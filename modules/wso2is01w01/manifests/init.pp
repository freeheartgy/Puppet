...
class wso2is01w01 (
  ...
  $members            = {'elb01w01.cloud-lbdev.datayes.com' => 4002, 'elb02w01.cloud-lbdev.datayes.com' => 4002 },
  $offset             = 0,
  $tribes_port        = 4000,
  $config_db          = 'identityserver',
  ...
  $group              = 'root',
  $target             = '/datayes',
) inherits wso2is01w01::params {

  $deployment_code = 'is'
  $carbon_version  = $version
  $service_code    = 'is'
  $carbon_home     = "${target}/wso2${service_code}-${carbon_version}-${hostname}"
  $template_path = '/etc/puppet/modules/wso2is/templates'
  $client_auth = "want"
