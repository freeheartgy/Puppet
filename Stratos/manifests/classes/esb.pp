class stratos::esb ( $version, 
	...
	$service_templates 	= $sub_cluster_domain ? {
                                        "mgt" =>    ["conf/registry.xml","conf/axis2/axis2.xml","conf/carbon.xml",
						     "deployment/server/webapps/STRATOS_ROOT/index.html","conf/security/authenticators.xml",
        ...
        $common_templates      = ["conf/etc/cache.xml","conf/multitenancy/cloud-services-desc.xml","conf/datasources/master-datasources.xml",
				  "conf/identity.xml","conf/user-mgt.xml","conf/etc/logging-config.xml", "conf/multitenancy/stratos.xml"]
