class stratos::bps ( $version, 
	...
	$service_templates 	= $sub_cluster_domain ? {
				   		     ...
				   		     "deployment/server/webapps/STRATOS_ROOT/index.html","conf/datasources.properties","conf/humantask.xml"],
                                        "worker" => ["conf/registry.xml","conf/axis2/axis2.xml","conf/carbon.xml","conf/security/authenticators.xml", 
				   		     "conf/datasources.properties","conf/humantask.xml"],
                                  }
