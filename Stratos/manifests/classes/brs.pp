class stratos::brs ( $version, 
	...
	$service_templates 	= $sub_cluster_domain ? {
                                        "mgt" =>    ["conf/registry.xml","conf/axis2/axis2.xml","deployment/server/webapps/STRATOS_ROOT/index.html",
						     "conf/carbon.xml","conf/security/authenticators.xml"],
