class stratos::am ( $version, 
	...
	$service_templates 	=  $sub_cluster_domain ? {
                                        "mgt" =>    ["conf/user-mgt.xml","conf/registry.xml","conf/api-manager.xml","conf/datasources/master-datasources.xml", "conf/axis2/axis2.xml", "conf/carbon.xml"],
                                        "worker" => ["conf/user-mgt.xml","conf/registry.xml","conf/api-manager.xml","conf/datasources/master-datasources.xml", "conf/axis2/axis2.xml", "conf/carbon.xml"],
                                  }
